    ...
    <div className="page--container">
      <div className="page">
        ...
        <div className="page--content">
          ...
          <p>I wanted it to feel more like a game than a traditional website.</p>

          <p>
            Since the beginning of time (or the internet), we've been trained to understand certain things about the way websites work.
            For instance, most people by now have caught on that this <FontAwesomeIcon icon={faBars} /> symbol means "menu".
            We have a solid communal understanding of what blogs, ecommerce shops, and portfolio websites should look like.
          </p>
          ...
          <p>
            I'm not trying to win a <a href="https://www.webbyawards.com/winners/2019//portfolio/" target="_blank">Webby</a> or anything. I'm just having some fun.
            <br /> <br />
